...
const UserDropdown = ({onOpenLogin}:{onOpenLogin:Dispatch<SetStateAction<boolean>>}) => {
    ...
    <Dropdown placement="bottom-end">
      ...
      <DropdownMenu aria-label="Profile Actions" variant="flat">
        <DropdownItem key="profile" className="h-14 gap-2 cursor-default">
          {userData.email === "" ? (
            <>
             Hello, <Button color="secondary" className=' font-extrabold bg-transparent' variant="light" onPress={() => {onOpenLogin(true)}}> Sign in</Button>
            </>
