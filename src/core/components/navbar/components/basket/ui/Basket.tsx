  ...
  return (
    <>
      {/* <Popover
        ...
        onOpenChange={(open) => setIsOpenShoppingCard(open)}
      ...
      >
        ...
        <Badge
          ...
          className="mt-2"
        >
          <PopoverTrigger className="cursor-pointer mt-3">
            <Avatar
              fallback={<ShoppingCardIcon />}
              className="bg-[#6D59A640]"
            />
          </PopoverTrigger>
        </Badge>
        ...
        <ModalContent>
          {() => (
            <>
              ...
              <ModalBody>
              {numberOfItems.map((items) => (
                <Item item={items} lastItemLength={numberOfItems.length - 1} itemsNumber = {numberOfItems.length}/>
            ))}
              </ModalBody>
              <ModalFooter>
