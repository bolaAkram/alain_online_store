...
const ProductDetails = () => {
  ...
  return (
    ...
    <div className="col-span-12 md:col-span-4">
      <ProductSection productsImages={selectedProduct.photos} />
    </div>
    ...
    <div className="col-span-12 md:col-span-7">
      <div className='my-4 w-full'>
        <div className="my-4 md:my-0 flex flex-col md:flex-row justify-center md:justify-between items-center md:items-start">
          <img src={brand1} alt="" className="mb-4 md:mb-0" />
          ...
          <div className="border border-[#F2F2F7] flex justify-between items-center p-2 rounded-full">
            ...
            <p className="ms-2 text-sm md:text-base">+25 People Watching</p>
            <hr className="h-10 w-[1px] bg-[#E5E5EA] mx-2" />
            <Button isIconOnly aria-label="Like" className="bg-transparent p-2">
              <Heart />
            </Button>
          </div>
        ...
        <p className='my-8 font-bold text-2xl'>{selectedProduct.description_english}</p>
        <div className='flex justify-between items-center'>
          <p className='font-normal text-3xl text-[#79747E]'>AED <span className='font-bold text-3xl text-secondary-500'>{selectedProduct.price}</span> </p>
          <div className='flex items-center'>
            <Star fill='#FF9500' stroke='none' />
            <span className=' underline ms-2 text-[#01010180] font-normal text-lg'>+1099 Review</span>
          </div>
        </div>

        <p className='my-9 text-danger font-normal text-xl flex items-center'><FlagTriangleRight className='text-danger' />Only 2 left on Stock</p>
        ...
        <div className='mt-7'>
          ...
          <RadioGroup size="sm"  orientation="horizontal"  description="Select a product category." label={<p className='font-bold text-black text-xl'>Category Name:</p>}>
            <CustomRadio
      ...
      <AddProductButton textColor={"dark"} iconColor={"gray-400"} numberOfProduct={1} containerBtnClass={"border-1 border-gray-300 rounded-full"}/>
        <Button radius='full' className='w-full my-4 text-lg border-1' color='secondary' variant='bordered' startContent={<ShoppingCardIcon color="#6D59A6" />}>Add to Basket</Button>
        <Button radius='full'  className='w-full my-4 text-lg' color='secondary' variant='solid' startContent={<CircleCheck size={20} />} >Buy Now</Button>
