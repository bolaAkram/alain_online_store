  ...
  return (
    ...
    <MobileFilter/>
     <div className='grid md:grid-cols-12'>
      ...
      <div className='mt-10'>
      <h3 className='font-bold text-gray-400'>Looking For <span className='text-secondary-600 ms-2'>“Beauty Care”</span></h3>
      <Products/>
      </div>
  ...
  <div className='md:col-span-4'>
    <div className='bg-[#6D59A6] bg-opacity-50 rounded-3xl'>
      <div className='bg-black rounded-t-3xl flex justify-center items-center py-5'>
        <p className='text-xl text-white font-bold'>Fast Shipping</p>
      </div>
      <div className='flex justify-center items-center'>
        <img src={fastShipping} className="w-full h-64 object-cover" alt=''/>
      </div>
    </div>
  </div>
  <div className='md:col-span-4'>
    <div className='bg-[#6D59A6] bg-opacity-50 rounded-3xl'>
      <div className='bg-black rounded-t-3xl flex justify-center items-center py-5'>
        <p className='text-xl text-white font-bold'>Online Payment</p>
      </div>
      <div className='flex justify-center items-center'>
        <img src={onlinePayment} className="w-full h-64 object-cover" alt=''/>
      </div>
    </div>
  </div>
  <div className='md:col-span-4'>
    <div className='bg-[#6D59A6] bg-opacity-50 rounded-3xl'>
      <div className='bg-black rounded-t-3xl flex justify-center items-center py-5'>
        <p className='text-xl text-white font-bold'>Customer Services</p>
      </div>
      <div className='flex justify-center items-center'>
        <img src={customerServices} className="w-full h-64 object-cover" alt=''/>
      </div>
    </div>
  </div>
</div>
