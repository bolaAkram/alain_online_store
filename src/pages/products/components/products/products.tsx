...
const Products = () => {
  const {i18n}=useTranslation()
    ...
    const currentItems = topSellerProducts.slice(startIndex, endIndex);
      ...
      if (value === PaginationItemType.NEXT) {
        return (
          <button
            ...
            onClick={onNext}
          >
            <ChevronRight className={i18n.language ==="en"?"":"rotate-180"}/>
  ...
  return (
    <div className="flex items-center flex-col">
      ...
      total={Math.ceil(topSellerProducts.length / itemsPerPage)}
      variant="light"
      classNames={{
